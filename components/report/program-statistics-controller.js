...
eRegistry.controller('ProgramStatisticsController',
         function($scope,
                DateUtils,                
                EnrollmentService,
                ProgramFactory,
    ...
    $scope.generateReport = function(program, report, ouMode){
        ...
        EnrollmentService.getByStartAndEndDate($scope.selectedProgram.id,
            ...
            if( data ) {
                ...
                DHIS2EventFactory.getByOrgUnitAndProgram($scope.selectedOrgUnit.id, $scope.selectedOuMode.displayName, $scope.selectedProgram.id, null, null).then(function(data){
